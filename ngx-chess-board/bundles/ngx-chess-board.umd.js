(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('lodash'), require('rxjs'), require('@angular/cdk/drag-drop')) :
    typeof define === 'function' && define.amd ? define('ngx-chess-board', ['exports', '@angular/core', '@angular/common', 'lodash', 'rxjs', '@angular/cdk/drag-drop'], factory) :
    (global = global || self, factory(global['ngx-chess-board'] = {}, global.ng.core, global.ng.common, global.lodash, global.rxjs, global.ng.cdk['drag-drop']));
}(this, (function (exports, core, common, lodash, rxjs, dragDrop) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxChessBoardService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxChessBoardService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgxChessBoardService_Factory() { return new NgxChessBoardService(); }, token: NgxChessBoardService, providedIn: "root" });
    ...
    var PiecePromotionModalComponent = /** @class */ (function () {
        ...
        PiecePromotionModalComponent.propDecorators = {
            modal: [{ type: core.ViewChild, args: ['myModal', { static: false },] }]
        };
    ...
    var NgxChessBoardComponent = /** @class */ (function () {
        function NgxChessBoardComponent(ngxChessBoardService) {
            ...
            this.onMove = new core.EventEmitter();
            this.selected = false;
        ...
        NgxChessBoardComponent.propDecorators = {
            ...
            darkTileColor: [{ type: core.Input, args: ['darkTileColor',] }],
            lightTileColor: [{ type: core.Input, args: ['lightTileColor',] }],
            showCoords: [{ type: core.Input, args: ['showCoords',] }],
            dragDisabled: [{ type: core.Input, args: ['dragDisabled',] }],
            drawDisabled: [{ type: core.Input, args: ['drawDisabled',] }],
            onMove: [{ type: core.Output }],
            boardRef: [{ type: core.ViewChild, args: ['boardRef', { static: false },] }],
            modal: [{ type: core.ViewChild, args: ['modal', { static: false },] }]
        };
    ...
    exports.ɵa = NgxChessBoardComponent;
    exports.ɵb = PiecePromotionModalComponent;
