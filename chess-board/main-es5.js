...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function distNgxChessBoardFesm2015NgxChessBoardJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgxChessBoardModule", function () {
      return NgxChessBoardModule;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxChessBoardService", function () {
    ...
    var Point = /*#__PURE__*/function () {
      ...
      _createClass(Point, [{
        ...
        key: "hasCoordsEqual",
        value: function hasCoordsEqual(row, col) {
    ...
    var Rook = /*#__PURE__*/function (_Piece) {
      ...
      function Rook(point, color, image, board) {
        ...
        _this = _super.call(this, point, color, image, 5, board);
      ...
      _createClass(Rook, [{
        ...
        value: function getPossibleMoves() {
          ...
          for (var _i = row - 1; _i >= 0; --_i) {
            // gora
            if (this.board.isFieldEmpty(_i, col)) {
              possiblePoints.push(new Point(_i, col));
            } else {
              break;
            }
          }
          ...
          for (var _j = col + 1; _j < 8; ++_j) {
            // prawo
            if (this.board.isFieldEmpty(row, _j)) {
              possiblePoints.push(new Point(row, _j));
            } else {
              break;
            }
          }
        ...
        value: function getPossibleCaptures() {
          /** @type {?} */
          var possiblePoints = [];
          /** @type {?} */
          ...
          for (var _i2 = row - 1; _i2 >= 0; --_i2) {
            // gora
            if (this.board.isFieldTakenByEnemy(_i2, col, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i2, col));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i2, col)) {
                break;
              }
            }
          }
          ...
          for (var _j2 = col + 1; _j2 < 8; ++_j2) {
            // prawo
            if (this.board.isFieldTakenByEnemy(row, _j2, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(row, _j2));
              break;
            } else {
              if (!this.board.isFieldEmpty(row, _j2)) {
                break;
              }
            }
          }
        ...
        key: "getCoveredFields",
        value: function getCoveredFields() {
          /** @type {?} */
          var possiblePoints = [];
          /** @type {?} */
          ...
          for (var _i3 = row - 1; _i3 >= 0; --_i3) {
            // gora
            if (this.board.isFieldEmpty(_i3, col)) {
              possiblePoints.push(new Point(_i3, col));
            } else {
              if (!(this.board.getPieceByField instanceof King)) {
                possiblePoints.push(new Point(_i3, col));
                break;
          ...
          for (var _j3 = col + 1; _j3 < 8; ++_j3) {
            // prawo
            if (this.board.isFieldEmpty(row, _j3)) {
              possiblePoints.push(new Point(row, _j3));
            } else {
              if (!(this.board.getPieceByField instanceof King)) {
                possiblePoints.push(new Point(row, _j3));
                break;
    ...
    var King = /*#__PURE__*/function (_Piece2) {
      ...
      function King(point, color, image, board) {
        ...
        _this2 = _super2.call(this, point, color, image, 0, board);
        _this2.castledAlready = false;
        _this2.shortCastled = false;
        _this2.longCastled = false;
        _this2.isCastling = false;
        return _this2;
      }
      /**
       * @return {?}
      ...
      _createClass(King, [{
        ...
        value: function getPossibleMoves() {
          ...
          if (!this.isMovedAlready) {
            ...
            for (var _i4 = col + 1; _i4 < 7; ++_i4) {
              if (!this.board.isFieldEmpty(row, _i4) || this.board.isFieldUnderAttack(row, _i4, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
    ...
    var UnicodeConstants = function UnicodeConstants() {
      _classCallCheck(this, UnicodeConstants);
    };
    ...
    var Queen = /*#__PURE__*/function (_Piece3) {
      _inherits(Queen, _Piece3);

      var _super3 = _createSuper(Queen);
      ...
      function Queen(point, color, image, board) {
        ...
        return _super3.call(this, point, color, image, 9, board);
      }
      /**
       * @return {?}
       */
      ...
      _createClass(Queen, [{
        ...
        value: function getPossibleMoves() {
          ...
          for (var _i5 = row - 1, _j4 = col + 1; _i5 >= 0 && _j4 < 8; --_i5, ++_j4) {
            // prawa gorna przekatna
            if (this.board.isFieldEmpty(_i5, _j4)) {
              possiblePoints.push(new Point(_i5, _j4));
            } else {
              break;
            }
          }

          for (var _i6 = row + 1, _j5 = col - 1; _i6 < 8 && _j5 >= 0; ++_i6, --_j5) {
            // lewa dolna przekatna
            if (this.board.isFieldEmpty(_i6, _j5)) {
              possiblePoints.push(new Point(_i6, _j5));
            } else {
              break;
            }
          }

          for (var _i7 = row + 1, _j6 = col + 1; _i7 < 8 && _j6 < 8; ++_i7, ++_j6) {
            // prawa dolna przekatna
            if (this.board.isFieldEmpty(_i7, _j6)) {
              possiblePoints.push(new Point(_i7, _j6));
            } else {
              break;
            }
          }

          for (var _i8 = row + 1; _i8 < 8; ++_i8) {
            // dol
            if (this.board.isFieldEmpty(_i8, col)) {
              possiblePoints.push(new Point(_i8, col));
            } else {
              break;
            }
          }

          for (var _i9 = row - 1; _i9 >= 0; --_i9) {
            // gora
            if (this.board.isFieldEmpty(_i9, col)) {
              possiblePoints.push(new Point(_i9, col));
            } else {
              break;
            }
          }

          for (var _j7 = col - 1; _j7 >= 0; --_j7) {
            // lewo
            if (this.board.isFieldEmpty(row, _j7)) {
              possiblePoints.push(new Point(row, _j7));
            } else {
              break;
            }
          }

          for (var _j8 = col + 1; _j8 < 8; ++_j8) {
            // prawo
            if (this.board.isFieldEmpty(row, _j8)) {
              possiblePoints.push(new Point(row, _j8));
            } else {
              break;
            }
          }
        ...
        value: function getPossibleCaptures() {
          ...
          for (var _i10 = row - 1, _j9 = col + 1; _i10 >= 0 && _j9 < 8; --_i10, ++_j9) {
            // prawa gorna przekatna
            if (this.board.isFieldTakenByEnemy(_i10, _j9, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i10, _j9));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i10, _j9)) {
                break;
              }
            }
          }

          for (var _i11 = row + 1, _j10 = col - 1; _i11 < 8 && _j10 >= 0; ++_i11, --_j10) {
            // lewa dolna przekatna
            if (this.board.isFieldTakenByEnemy(_i11, _j10, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i11, _j10));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i11, _j10)) {
                break;
              }
            }
          }

          for (var _i12 = row + 1, _j11 = col + 1; _i12 < 8 && _j11 < 8; ++_i12, ++_j11) {
            // prawa dolna przekatna
            if (this.board.isFieldTakenByEnemy(_i12, _j11, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i12, _j11));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i12, _j11)) {
                break;
              }
            }
          }

          for (var _i13 = row + 1; _i13 < 8; ++_i13) {
            // dol
            if (this.board.isFieldTakenByEnemy(_i13, col, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i13, col));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i13, col)) {
                break;
              }
            }
          }

          for (var _i14 = row - 1; _i14 >= 0; --_i14) {
            // gora
            if (this.board.isFieldTakenByEnemy(_i14, col, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i14, col));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i14, col)) {
                break;
              }
            }
          }

          for (var _j12 = col - 1; _j12 >= 0; --_j12) {
            // lewo
            if (this.board.isFieldTakenByEnemy(row, _j12, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(row, _j12));
              break;
            } else {
              if (!this.board.isFieldEmpty(row, _j12)) {
                break;
              }
            }
          }

          for (var _j13 = col + 1; _j13 < 8; ++_j13) {
            // prawo
            if (this.board.isFieldTakenByEnemy(row, _j13, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(row, _j13));
              break;
            } else {
              if (!this.board.isFieldEmpty(row, _j13)) {
                break;
              }
            }
          }
        ...
        value: function getCoveredFields() {
          ...
          for (var _i15 = row - 1; _i15 >= 0; --_i15) {
            // gora
            if (this.board.isFieldEmpty(_i15, col)) {
              possiblePoints.push(new Point(_i15, col));
            } else {
              if (!(this.board.getPieceByField(_i15, col) instanceof King)) {
                possiblePoints.push(new Point(_i15, col));
                break;
              }
            }
          ...
          for (var _j14 = col + 1; _j14 < 8; ++_j14) {
            // prawo
            if (this.board.isFieldEmpty(row, _j14)) {
              possiblePoints.push(new Point(row, _j14));
            } else {
              if (!(this.board.getPieceByField(row, _j14) instanceof King)) {
                possiblePoints.push(new Point(row, _j14));
                break;
              }
            }
          ...
          for (var _i16 = row - 1, _j15 = col - 1; _i16 >= 0 && _j15 >= 0; --_i16, --_j15) {
            // lewa gorna przekatna
            if (this.board.isFieldEmpty(_i16, _j15)) {
              possiblePoints.push(new Point(_i16, _j15));
            } else {
              if (!(this.board.getPieceByField(_i16, _j15) instanceof King)) {
                possiblePoints.push(new Point(_i16, _j15));
                break;
              }
            }
          ...
          for (var _i17 = row - 1, _j16 = col + 1; _i17 >= 0 && _j16 < 8; --_i17, ++_j16) {
            // prawa gorna przekatna
            if (this.board.isFieldEmpty(_i17, _j16)) {
              possiblePoints.push(new Point(_i17, _j16));
            } else {
              if (!(this.board.getPieceByField(_i17, _j16) instanceof King)) {
                possiblePoints.push(new Point(_i17, _j16));
                break;
              }
            }
          ...
          for (var _i18 = row + 1, _j17 = col - 1; _i18 < 8 && _j17 >= 0; ++_i18, --_j17) {
            // lewa dolna przekatna
            if (this.board.isFieldEmpty(_i18, _j17)) {
              possiblePoints.push(new Point(_i18, _j17));
            } else {
              if (!(this.board.getPieceByField(_i18, _j17) instanceof King)) {
                possiblePoints.push(new Point(_i18, _j17));
                break;
              }
            }
          ...
          for (var _i19 = row + 1, _j18 = col + 1; _i19 < 8 && _j18 < 8; ++_i19, ++_j18) {
            // prawa dolna przekatna
            if (this.board.isFieldEmpty(_i19, _j18)) {
              possiblePoints.push(new Point(_i19, _j18));
            } else {
              if (!(this.board.getPieceByField(_i19, _j18) instanceof King)) {
                possiblePoints.push(new Point(_i19, _j18));
                break;
              }
            }
    ...
    var Pawn = /*#__PURE__*/function (_Piece4) {
      ...
      function Pawn(point, color, image, board) {
        ...
        _this3 = _super4.call(this, point, color, image, 1, board);
        _this3.isMovedAlready = false;
        return _this3;
      }
      /**
       * @return {?}
    ...
    var Knight = /*#__PURE__*/function (_Piece5) {
      _inherits(Knight, _Piece5);

      var _super5 = _createSuper(Knight);
      ...
      function Knight(point, color, image, board) {
        ...
        _this4 = _super5.call(this, point, color, image, 3, board);
        _this4.isMovedAlready = false;
        return _this4;
      }
      /**
       * @return {?}
      ...
      _createClass(Knight, [{
        ...
        value: function getPossibleMoves() {
          ...
          var col = this.point.col; // gora -> lewo
    ...
    var Bishop = /*#__PURE__*/function (_Piece6) {
      _inherits(Bishop, _Piece6);

      var _super6 = _createSuper(Bishop);
      ...
      function Bishop(point, color, image, board) {
        ...
        return _super6.call(this, point, color, image, 3, board);
      }
      /**
       * @return {?}
       */
      ...
      _createClass(Bishop, [{
        ...
        value: function getPossibleMoves() {
          ...
          for (var _i20 = row - 1, _j19 = col + 1; _i20 >= 0 && _j19 < 8; --_i20, ++_j19) {
            // prawa gorna przekatna
            if (this.board.isFieldEmpty(_i20, _j19)) {
              possiblePoints.push(new Point(_i20, _j19));
            } else {
              break;
            }
          }

          for (var _i21 = row + 1, _j20 = col - 1; _i21 < 8 && _j20 >= 0; ++_i21, --_j20) {
            // lewa dolna przekatna
            if (this.board.isFieldEmpty(_i21, _j20)) {
              possiblePoints.push(new Point(_i21, _j20));
            } else {
              break;
            }
          }

          for (var _i22 = row + 1, _j21 = col + 1; _i22 < 8 && _j21 < 8; ++_i22, ++_j21) {
            // prawa dolna przekatna
            if (this.board.isFieldEmpty(_i22, _j21)) {
              possiblePoints.push(new Point(_i22, _j21));
            } else {
              break;
            }
          }
        ...
        value: function getPossibleCaptures() {
          ...
          for (var _i23 = row - 1, _j22 = col + 1; _i23 >= 0 && _j22 < 8; --_i23, ++_j22) {
            // prawa gorna przekatna
            if (this.board.isFieldTakenByEnemy(_i23, _j22, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i23, _j22));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i23, _j22)) {
                break;
              }
            }
          }

          for (var _i24 = row + 1, _j23 = col - 1; _i24 < 8 && _j23 >= 0; ++_i24, --_j23) {
            // lewa dolna przekatna
            if (this.board.isFieldTakenByEnemy(_i24, _j23, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i24, _j23));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i24, _j23)) {
                break;
              }
            }
          }

          for (var _i25 = row + 1, _j24 = col + 1; _i25 < 8 && _j24 < 8; ++_i25, ++_j24) {
            // prawa dolna przekatna
            if (this.board.isFieldTakenByEnemy(_i25, _j24, this.color === Color.WHITE ? Color.BLACK : Color.WHITE)) {
              possiblePoints.push(new Point(_i25, _j24));
              break;
            } else {
              if (!this.board.isFieldEmpty(_i25, _j24)) {
                break;
              }
            }
          }
        ...
        value: function getCoveredFields() {
          ...
          for (var i = row - 1, j = col - 1; i >= 0 && j >= 0; --i, --j) {
            // lewa gorna przekatna
            if (this.board.isFieldEmpty(i, j)) possiblePoints.push(new Point(i, j));else {
          ...
          for (var _i26 = row - 1, _j25 = col + 1; _i26 >= 0 && _j25 < 8; --_i26, ++_j25) {
            // prawa gorna przekatna
            if (this.board.isFieldEmpty(_i26, _j25)) possiblePoints.push(new Point(_i26, _j25));else {
              if (!(this.board.getPieceByField(_i26, _j25) instanceof King)) {
                possiblePoints.push(new Point(_i26, _j25));
                break;
              }
            }
          }

          for (var _i27 = row + 1, _j26 = col - 1; _i27 < 8 && _j26 >= 0; ++_i27, --_j26) {
            // lewa dolna przekatna
            if (this.board.isFieldEmpty(_i27, _j26)) possiblePoints.push(new Point(_i27, _j26));else {
              if (!(this.board.getPieceByField(_i27, _j26) instanceof King)) {
                possiblePoints.push(new Point(_i27, _j26));
                break;
              }
            }
          }

          for (var _i28 = row + 1, _j27 = col + 1; _i28 < 8 && _j27 < 8; ++_i28, ++_j27) {
            // prawa dolna przekatna
            if (this.board.isFieldEmpty(_i28, _j27)) possiblePoints.push(new Point(_i28, _j27));else {
              if (!(this.board.getPieceByField(_i28, _j27) instanceof King)) {
                possiblePoints.push(new Point(_i28, _j27));
                break;
              }
            }
          }
    ...
    var Board = /*#__PURE__*/function () {
      ...
      _createClass(Board, [{
        key: "isXYInPossibleMoves",
        value: function isXYInPossibleMoves(row, col) {
        ...
        key: "isXYInPossibleCaptures",
        value: function isXYInPossibleCaptures(row, col) {
        ...
        key: "isXYInSourceMove",
        value: function isXYInSourceMove(i, j) {
        ...
        key: "isXYInDestMove",
        value: function isXYInDestMove(i, j) {
        ...
        key: "isXYInActiveMove",
        value: function isXYInActiveMove(i, j) {
        ...
        key: "isPointInPossibleMoves",
        value: function isPointInPossibleMoves(point) {
          return this.possibleMoves.some(
          /**
          * @param {?} e
          * @return {?}
          */
          function (e) {
            return e.row === point.row && e.col === point.col;
          });
        }
        /**
         * @param {?} point
        ...
        key: "isPointInPossibleCaptures",
        value: function isPointInPossibleCaptures(point) {
          return this.possibleCaptures.some(
          /**
          * @param {?} e
          * @return {?}
        ...
        key: "reversePoint",
        value: function reversePoint(point) {
          if (point) {
        ...
        key: "isFieldTakenByEnemy",
        value: function isFieldTakenByEnemy(row, col, enemyColor) {
          ...
          */
          function (e) {
            return e.point.col === col && e.point.row === row && e.color === enemyColor;
          });
        }
        /**
         * @param {?} row
        ...
        key: "isFieldEmpty",
        value: function isFieldEmpty(row, col) {
          if (row > 7 || row < 0 || col > 7 || col < 0) {
            return false;
          }
          ...
          */
          function (e) {
            return e.point.col === col && e.point.row === row;
          });
        }
        /**
         * @param {?} row
        ...
        key: "isFieldUnderAttack",
        value: function isFieldUnderAttack(row, col, color) {
          /** @type {?} */
          var found = false;
          ...
          */
          function (e) {
            return e.getCoveredFields().some(
            /**
            * @param {?} f
            * @return {?}
            */
        ...
        key: "getPieceByField",
        value: function getPieceByField(row, col) {
        ...
        key: "isKingInCheck",
        value: function isKingInCheck(color, piece) {
          /** @type {?} */
          var king = piece.find(
          /**
          * @param {?} e
          ...
          */
          function (e) {
            return e.color === color && e instanceof King;
          });
          ...
          if (king) {
            ...
            */
            function (e) {
              return e.getPossibleCaptures().some(
              /**
              * @param {?} e
              * @return {?}
              */
              function (e) {
                return e.col === king.point.col && e.row === king.point.row;
              }) && e.color !== color;
            });
          }
        ...
        key: "getKingByColor",
        value: function getKingByColor(color) {
          return (
            /** @type {?} */
            this.pieces.find(
            /**
            ...
            */
            function (e) {
              return e instanceof King && e.color === color;
            })
          );
        }
        /**
        ...
        key: "getCastleFENString",
        value: function getCastleFENString(color) {
          /** @type {?} */
        ...
        key: "getEnPassantFENString",
        value: function getEnPassantFENString() {
        ...
        value: function calculateFEN() {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
              /** @type {?} */
              var piece = _this5.pieces.find(
              /**
              * @param {?} e
              * @return {?}
              */
              function (e) {
                return e.point.col === j && e.point.row === i;
              });
        ...
        key: "isXYInPointSelection",
        value: function isXYInPointSelection(i, j) {
          return false;
        }
      }]);
    ...
    var MoveUtils = /*#__PURE__*/function () {
      function MoveUtils() {
        _classCallCheck(this, MoveUtils);
      }

      _createClass(MoveUtils, null, [{
        key: "willMoveCauseCheck",
         ...
         * @return {?}
         */
        value: function willMoveCauseCheck(currentColor, row, col, destRow, destCol, board) {
          /** @type {?} */
        ...
        key: "format",
        value: function format(sourcePoint, destPoint, reverted) {
          if (reverted) {
            /** @type {?} */
    ...
    var NgxChessBoardService = /*#__PURE__*/function () {
      function NgxChessBoardService() {
        _classCallCheck(this, NgxChessBoardService);
      ...
      _createClass(NgxChessBoardService, [{
        key: "reset",
        value: function reset() {
    ...
    NgxChessBoardService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"])({
      factory: function NgxChessBoardService_Factory() {
        return new NgxChessBoardService();
      },
    ...
    var PieceAbstractDecorator =
    /**
     * @protected
     * @param {?} piece
     */
    function PieceAbstractDecorator(piece) {
      _classCallCheck(this, PieceAbstractDecorator);
    ...
    var AvailableMoveDecorator = /*#__PURE__*/function (_PieceAbstractDecorat) {
      _inherits(AvailableMoveDecorator, _PieceAbstractDecorat);

      var _super7 = _createSuper(AvailableMoveDecorator);
      ...
      function AvailableMoveDecorator(piece, pointClicked, color, board) {
        ...
        _classCallCheck(this, AvailableMoveDecorator);

        _this6 = _super7.call(this, piece);
        _this6.pointClicked = pointClicked;
        _this6.color = color;
        _this6.board = board;
        return _this6;
      }
      ...
      _createClass(AvailableMoveDecorator, [{
        key: "getPossibleCaptures",
        value: function getPossibleCaptures() {
          var _this7 = this;

          return this.piece.getPossibleCaptures().filter(
          /**
          * @param {?} point
          * @return {?}
          */
          function (point) {
            return !MoveUtils.willMoveCauseCheck(_this7.color, _this7.pointClicked.row, _this7.pointClicked.col, point.row, point.col, _this7.board);
          });
        }
        /**
         * @return {?}
        ...
        value: function getPossibleMoves() {
          ...
          return this.piece.getPossibleMoves().filter(
          /**
          * @param {?} point
          * @return {?}
          */
          function (point) {
            return !MoveUtils.willMoveCauseCheck(_this8.color, _this8.pointClicked.row, _this8.pointClicked.col, point.row, point.col, _this8.board);
          });
        }
      }]);
    ...
    var BoardStateProvider = /*#__PURE__*/function () {
      function BoardStateProvider() {
        _classCallCheck(this, BoardStateProvider);
      ...
      _createClass(BoardStateProvider, [{
        key: "addMove",
        value: function addMove(moveHistory) {
    ...
    function HistoryMove(move, piece, color) {
      _classCallCheck(this, HistoryMove);
    ...
    var HistoryMoveProvider = /*#__PURE__*/function () {
      function HistoryMoveProvider() {
        _classCallCheck(this, HistoryMoveProvider);
      ...
      _createClass(HistoryMoveProvider, [{
        key: "addMove",
        value: function addMove(historyMove) {
    ...
    var CoordsProvider = /*#__PURE__*/function () {
      function CoordsProvider() {
        _classCallCheck(this, CoordsProvider);
    ...
    var BoardLoader = /*#__PURE__*/function () {
      /**
       * @param {?} board
       */
      function BoardLoader(board) {
        _classCallCheck(this, BoardLoader);
      ...
      _createClass(BoardLoader, [{
        key: "addPieces",
        value: function addPieces() {
          this.board.pieces = []; // piony czarne
          ...
          this.board.pieces.push(new Rook(new Point(0, 7), Color.BLACK, UnicodeConstants.BLACK_ROOK, this.board)); // piony biale

          for (var _i29 = 0; _i29 < 8; ++_i29) {
            this.board.pieces.push(new Pawn(new Point(6, _i29), Color.WHITE, UnicodeConstants.WHITE_PAWN, this.board));
          }
                ...
                if (chunk.match(/[0-9]/)) {
                  ...
                  switch (chunk) {
                    ...
                    case 'P':
                      {
                        /** @type {?} */
                        var _pawn = new Pawn(new Point(i, pointer), Color.WHITE, UnicodeConstants.WHITE_PAWN, this.board);

                        if (_pawn.color === Color.BLACK && _pawn.point.row !== 1 || _pawn.color === Color.WHITE && _pawn.point.row !== 6) {
                          _pawn.isMovedAlready = true;
                        }

                        this.board.pieces.push(_pawn);
                        break;
                      }
                  }
        ...
        value: function setCurrentPlayer(fen) {
          if (fen) {
            /** @type {?} */
            var split = fen.split(' ');
        ...
        key: "setFullMoveCount",
        value: function setFullMoveCount(fen) {}
        /**
         * @private
         * @param {?} fen
         * @return {?}
        ...
        key: "setEnPassant",
        value: function setEnPassant(fen) {
          if (fen) {
            /** @type {?} */
            var split = fen.split(' ');
            /** @type {?} */
        ...
        key: "setRookAlreadyMoved",
        value: function setRookAlreadyMoved(color, col) {
          /** @type {?} */
          var rook =
          /** @type {?} */
          ...
          */
          function (e) {
            return e.color === color && e instanceof Rook && e.point.col === col;
          });
    ...
    var PiecePromotionModalComponent = /*#__PURE__*/function () {
      function PiecePromotionModalComponent() {
        _classCallCheck(this, PiecePromotionModalComponent);
      ...
      _createClass(PiecePromotionModalComponent, [{
        key: "open",
        value: function open(closeCallback) {
    ...
    var DrawPoint = /*#__PURE__*/function () {
      /**
       * @param {?} x
       * @param {?} y
       */
    ...
    var DrawProvider = /*#__PURE__*/function () {
      function DrawProvider() {
        _classCallCheck(this, DrawProvider);
      ...
      _createClass(DrawProvider, [{
         ...
         * @return {?}
         */
        value: function containsCircle(circle) {
        ...
        key: "containsArrow",
        value: function containsArrow(arrow) {
    ...
    var NgxChessBoardComponent = /*#__PURE__*/function () {
      /**
       * @param {?} ngxChessBoardService
       */
      function NgxChessBoardComponent(ngxChessBoardService) {
        _classCallCheck(this, NgxChessBoardComponent);
      ...
      _createClass(NgxChessBoardComponent, [{
        key: "onRightClick",
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 11:
                    ...
                    this.handleClickEvent(pointClicked); //   this.possibleMoves = activePiece.getPossibleMoves();
        ...
        value: function afterMoveActions() {
        ...
        key: "prepareActivePiece",
        value: function prepareActivePiece(pieceClicked, pointClicked) {
        ...
        key: "getPieceByPoint",
        value: function getPieceByPoint(row, col) {
          row = Math.floor(row);
          col = Math.floor(col);
        ...
        key: "isKingChecked",
        value: function isKingChecked(piece) {
        ...
        key: "getClickPoint",
        value: function getClickPoint(event) {
        ...
        key: "movePiece",
        value: function movePiece(piece, newPoint) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    */
                    function (e) {
                      return e.point.col === newPoint.col && e.point.row === newPoint.row;
                    });
                  ...
                  case 8:
                    ...
                    return _context3.abrupt("return", this.checkForPawnPromote(piece));
        ...
        key: "checkIfPawnFirstMove",
        value: function checkIfPawnFirstMove(piece) {
          if (piece instanceof Pawn) {
            /** @type {?} */
        ...
        key: "checkIfRookMoved",
        value: function checkIfRookMoved(piece) {
          if (piece instanceof Rook) {
            piece.isMovedAlready = true;
          }
        }
        ...
        key: "checkIfKingMoved",
        value: function checkIfKingMoved(piece) {
          if (piece instanceof King) {
            piece.isMovedAlready = true;
          }
        }
        ...
        key: "checkForPawnPromote",
        value: function checkForPawnPromote(piece) {
        ...
        key: "openPromoteDialog",
        value: function openPromoteDialog(piece) {
                  ...
                  case 0:
                    ...
                    */
                    function (index) {
                      ...
                      switch (index) {
                        case 1:
                          _this10.board.pieces.push(new Queen(piece.point, piece.color, isWhite ? UnicodeConstants.WHITE_QUEEN : UnicodeConstants.BLACK_QUEEN, _this10.board));

                          break;

                        case 2:
                          _this10.board.pieces.push(new Rook(piece.point, piece.color, isWhite ? UnicodeConstants.WHITE_ROOK : UnicodeConstants.BLACK_ROOK, _this10.board));

                          break;

                        case 3:
                          _this10.board.pieces.push(new Bishop(piece.point, piece.color, isWhite ? UnicodeConstants.WHITE_BISHOP : UnicodeConstants.BLACK_BISHOP, _this10.board));

                          break;

                        case 4:
                          _this10.board.pieces.push(new Knight(piece.point, piece.color, isWhite ? UnicodeConstants.WHITE_KNIGHT : UnicodeConstants.BLACK_KNIGHT, _this10.board));
        ...
        key: "checkForPossibleMoves",
        value: function checkForPossibleMoves(color, text) {
          var _this11 = this;
          ...
          */
          function (e) {
            return e.getPossibleMoves().some(
            /**
            * @param {?} f
            * @return {?}
            */
            function (f) {
              return !MoveUtils.willMoveCauseCheck(color, e.point.row, e.point.col, f.row, f.col, _this11.board);
        ...
        key: "checkForPat",
        value: function checkForPat(color) {
        ...
        key: "checkIfPawnEnpassanted",
        value: function checkIfPawnEnpassanted(piece, newPoint) {
        ...
        key: "checkIfPawnTakesEnPassant",
        value: function checkIfPawnTakesEnPassant(newPoint) {
          var _this12 = this;
          ...
          if (newPoint.isEqual(this.board.enPassantPoint)) {
            ...
            */
            function (piece) {
              return piece !== _this12.board.enPassantPiece;
            });
            this.board.enPassantPoint = null;
            this.board.enPassantPiece = null;
          }
        ...
        key: "calculatePieceSize",
        value: function calculatePieceSize() {
        ...
        key: "increaseFullMoveCount",
        value: function increaseFullMoveCount() {
        ...
        value: function handleClickEvent(pointClicked) {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    _context6.next = 6;
                    return this.movePiece(this.board.activePiece, pointClicked);
        ...
        key: "getDrawingPoint",
        value: function getDrawingPoint(x, y) {
          /** @type {?} */
        ...
        key: "addDrawPoint",
        value: function addDrawPoint(x, y) {
          /** @type {?} */
    ...
    NgxChessBoardComponent.ctorParameters = function () {
      return [{
    ...
    var NgxChessBoardModule = /*#__PURE__*/function () {
      function NgxChessBoardModule() {
        _classCallCheck(this, NgxChessBoardModule);
      }

      _createClass(NgxChessBoardModule, null, [{
        key: "forRoot",
    ...
    NgxChessBoardModule.decorators = [{
      ...
      args: [{
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_5__["DragDropModule"]],
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_chess_board__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ngx-chess-board */
    "./dist/ngx-chess-board/fesm2015/ngx-chess-board.js");
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "showMoveHistory",
        value: function showMoveHistory() {
          alert(this.board.getMoveHistory());
        }
      }, {
        key: "setFen",
        value: function setFen() {
          alert('Setting FEN');
        ...
        key: "getFEN",
        value: function getFEN() {
          var fen = this.board.getFEN();
          alert(fen);
        }
      }, {
        key: "moveCallback",
        value: function moveCallback() {
          this.fen = this.board.getFEN();
        }
      }, {
        key: "switchDrag",
        value: function switchDrag() {
          this.dragDisabled = !this.dragDisabled;
        }
      }, {
        key: "switchDraw",
        value: function switchDraw() {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_chess_board__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ngx-chess-board */
    "./dist/ngx-chess-board/fesm2015/ngx-chess-board.js");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], ngx_chess_board__WEBPACK_IMPORTED_MODULE_4__["NgxChessBoardModule"].forRoot()],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Komputer\Desktop\Nowy folder\chess-board\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
